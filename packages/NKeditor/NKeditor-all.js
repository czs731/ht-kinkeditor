...
function KEditor(options) {
	...
	console.log(K.options,'4949494949494994949494')
...
KindEditor.plugin('multiimage', function(K) {
	...
	if(typeof jQuery == 'undefined') {
		...
		console.log(K.options,111111111111111);
		console.log(K.options.pluginsPath,111111111111111);
